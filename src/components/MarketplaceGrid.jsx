...
function EmptyState({ onClear, message }) {
  return (
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
        <div>
          ...
          <p style={{ color: '#6B7280', fontSize: 14 }}>
            {loading ? 'Loading items...' : `${totalCount} item${totalCount !== 1 ? 's' : ''} found`}
          </p>
        </div>
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          <div style={{ display: 'flex', gap: 8 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', background: '#fff', borderRadius: 10, border: '1px solid #E2E8F0', fontSize: 13, color: '#374151', fontWeight: 500 }}>
