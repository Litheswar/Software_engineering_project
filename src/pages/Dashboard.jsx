        ...
        <div style={{ marginTop: 40 }}>
          <div style={{ display: 'flex', gap: 32, alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: 1 }}>
              <ErrorBoundary>
                {fetchError ? (
                  <div style={{ padding: 48, background: '#FEF2F2', borderRadius: 20, textAlign: 'center', border: '1px solid #FEE2E2' }}>
                    <div style={{ fontSize: 48, marginBottom: 16 }}>⚠️</div>
                    <h3 style={{ color: '#991B1B', fontWeight: 700, marginBottom: 8 }}>Unable to load marketplace items</h3>
                    <p style={{ color: '#C53030', fontSize: 14, marginBottom: 20 }}>There was a problem connecting to the database. Please try again.</p>
                    <button 
                      onClick={() => window.location.reload()} 
                      style={{ background: '#EF4444', color: '#fff', border: 'none', padding: '12px 24px', borderRadius: 12, fontWeight: 600, cursor: 'pointer' }}
                    >
                      Refresh Page
                    </button>
                  </div>
